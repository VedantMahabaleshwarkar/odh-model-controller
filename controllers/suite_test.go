...
const (
	...
	caikitIsvcPath             = "./testdata/deploy/caikit-inference-service.yaml"
	...
	ExpectedPeerAuthPath       = "./testdata/results/peerauthentication-kserve.yaml"
	ExpectedNetworkPolicyPath  = "./testdata/results/networkpolicy-kserve-uwm.yaml"
