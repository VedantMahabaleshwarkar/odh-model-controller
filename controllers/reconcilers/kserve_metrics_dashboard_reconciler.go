...
func NewKserveMetricsDashboardReconciler(client client.Client, scheme *runtime.Scheme) *KserveMetricsDashboardReconciler {
...
func (r *KserveMetricsDashboardReconciler) createDesiredResource(log logr.Logger, isvc *kservev1beta1.InferenceService) (*corev1.ConfigMap, error) {
	...
	if err := ctrl.SetControllerReference(isvc, configMap, r.scheme); err != nil {
